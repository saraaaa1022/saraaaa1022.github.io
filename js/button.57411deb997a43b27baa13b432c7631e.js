__twttrll([2], {
        ...
        function s(t) {
            t.params({
                ...
                var t = h(d, {
                    ...
                    e = u.base() + t + "#" + a;
                return this.scribeImpression(), r.all([this.sandbox.setTitle(f), this.sandbox.addClass(w), this.sandbox.loadDocument(e)])
            })
        }
        var r = e(2),
            i = e(84),
    ...
    113: function(t, a) {
        t.exports = {
            tweetButtonHtmlPath: "/widgets/tweet_button.b8b8e09be0884a395c5ae18831ce1cc0.{{lang}}.html",
            followButtonHtmlPath: "/widgets/follow_button.b8b8e09be0884a395c5ae18831ce1cc0.{{lang}}.html",
    ...
    229: function(t, a, e) {
        ...
        function o(t) {
            t.params({
                ...
                return "share" === this.params.type ? (t = t || m.title, a = a || b.getCanonicalURL() || h.href, e = e || s) : s && (n = n ? s + "," + n : s), d.compact({
                    id: this.id,
                    lang: this.params.lang,
                    size: this.params.size,
                ...
                return "mention" == this.params.type ? d.aug({
                    "screen-name": this.params.screenName
                }, t()) : "hashtag" == this.params.type ? d.aug({
