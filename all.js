/*1485537217,,JIT Construction: v2800705,en_US*/
 ...
 */
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/Sh-3BhStODe.js?version=42",
                    "Flash": {
                        ...
                        p = k.extend({
                            ...
                            parse: function q(r) {
                                ...
                                for (var u = 1; u < r.length; u++)
                                    if (j.instanceOf(p, r[u]))
                                        r[u].hasDependency(true);
                                return this;
                            },
                            toFql: function q() {
                                ...
                                case 'in':
                                    if (this.where.value.length == 1) {
                                        ...
                                        r += this.where.key + ' in (' + ES(this.where.value, 'map', true, n).join(',') + ')';
                                    break;
                                }
                                return r;
                            },
                        ...
                        _process: function o(p) {
                            ...
                            h('/fql', 'GET', u, function(w) {
                                if (w.error) {
                                    ...
                                    ES(w.data, 'forEach', true, function(x) {
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2800705","namespace":"FB","message":"' + e.message + '"}}');
}
